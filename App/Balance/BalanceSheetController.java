package Problems.SplitWise.App.Balance;
...
public class BalanceSheetController {
    public static void updateUserExpenseBalanceSheet(User expensePaidBy, List<Split> splits, double totalExpenseAmount){
    ...
    public static void showBalanceSheetOfUser(User user){
